              ...
              <CardContent className="p-4">
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <img 
                      src="/uploads/dbe47511-e68c-4c73-b11f-029f79b9ff31.png" 
                      alt="InventorySprint Flag Order Feature Interface"
                  ...
                  <DialogContent className="max-w-[90vw] w-full p-0 bg-transparent border-none">
                    <img 
                      src="/uploads/dbe47511-e68c-4c73-b11f-029f79b9ff31.png" 
                      alt="InventorySprint Flag Order Feature Interface (Zoomed)"
