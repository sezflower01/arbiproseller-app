...
interface ManagedListingsSettingsProps {
...
const ManagedListingsSettings: React.FC<ManagedListingsSettingsProps> = ({
  activeListings,
  effectivePlan,
  marketplaceCounts,
  loading,
  ...
  return (
    <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-[hsl(222,84%,4.9%)] via-[hsl(230,50%,10%)] to-[hsl(260,50%,8%)] border border-white/10 relative">
      ...
      <div className="relative z-10 p-6">
        <div className="flex items-center gap-2 text-white text-lg font-bold mb-6">
        ...
        <div className="flex items-center gap-6 mb-6">
          <div className="relative flex-shrink-0" style={{ width: 120, height: 120 }}>
            <svg width="120" height="120" viewBox="0 0 120 120" className="transform -rotate-90">
              ...
              <circle
                ...
                stroke={isOver ? "hsl(0, 84%, 60%)" : "url(#settingsGaugeGradient)"}
                strokeWidth="8" strokeLinecap="round"
                strokeDasharray={circumference} strokeDashoffset={strokeDashoffset}
                className="transition-all duration-1000 ease-out"
              />
              <defs>
                <linearGradient id="settingsGaugeGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <div className="flex flex-col gap-2 min-w-0">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">assigned repricer slots across all marketplaces</p>
              <p className="text-[11px] text-gray-500 mt-1 max-w-[320px]">
                Each ASIN + marketplace with a repricer rule assigned counts as one slot — even if it's
                waiting for inventory, inactive, paused, or temporarily suspended.
              </p>
            </div>
            {loading ? (
...
export default ManagedListingsSettings;
