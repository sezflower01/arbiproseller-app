              ...
              <CardContent className="p-4">
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <img 
                      src="/uploads/941747d9-e58f-481a-9685-cee9e4868431.png" 
                      alt="InventorySprint Mark Units Received Feature Interface"
                  ...
                  <DialogContent className="max-w-[90vw] w-full p-0 bg-transparent border-none">
                    <img 
                      src="/uploads/941747d9-e58f-481a-9685-cee9e4868431.png" 
                      alt="InventorySprint Mark Units Received Feature Interface (Zoomed)"
