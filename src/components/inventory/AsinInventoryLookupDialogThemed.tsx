...
// Light "InventoryHub" re-theme of AsinInventoryLookupDialog.tsx — identical
// lookup logic. Only change: the trigger button's custom one-off yellow color
// swapped for the standard Button `default` variant (button-standardization pass).
...
const AsinInventoryLookupDialogThemed = () => {
  const { user } = useAuth();
...
export default AsinInventoryLookupDialogThemed;
