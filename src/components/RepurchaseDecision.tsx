              ...
              <CardContent className="p-4">
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <img 
                      src="/uploads/710f6a23-783a-4e0e-93e5-eda9dd0c3421.png" 
                      alt="InventorySprint main application interface showing dashboard and product management features"
                  ...
                  <DialogContent className="max-w-[90vw] w-full p-0 bg-transparent border-none">
                    <img 
                      src="/uploads/710f6a23-783a-4e0e-93e5-eda9dd0c3421.png" 
                      alt="InventorySprint main application interface (Zoomed)"
