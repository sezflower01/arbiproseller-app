  ...
  },
  {
    ...
    modules: [
      ...
      },
      {
        ...
        adminOnly: true,
        ga: "tool_menu_reports",
      },
      {
        path: "/tools/shipment-accounting",
        label: "Shipment Profit & Loss",
        description: "Per-shipment cost breakdown: COGS, Amazon inbound fees, manual costs and totals.",
        icon: Receipt,
        color: "from-emerald-500 to-teal-600",
        adminOnly: false,
        ga: "tool_menu_shipment_accounting",
      },
      {
        path: "/tools/price-discrepancy-audit",
        label: "Price Discrepancy Audit",
        description: "Compare My Price vs Sales Report vs Live Mobile per order to diagnose revenue mismatches.",
        icon: AlertTriangle,
        color: "from-orange-500 to-red-600",
        adminOnly: true,
        ga: "tool_menu_price_discrepancy_audit",
      },
    ],
  },
  {
