...
export const TOOLS: ToolLink[] = [
  ...
  { path: '/tools/repricer/activity-log', label: 'Repricer Activity Log', ga: 'tool_menu_repricer_activity_log', adminOnly: true },
  { path: '/tools/price-history', label: 'Repricer Price History', ga: 'tool_menu_repricer_price_history', adminOnly: true },
  { path: '/tools/ai-insights', label: 'Repricer AI Insights', ga: 'tool_menu_repricer_ai_insights', adminOnly: true },
  { path: '/tools/repricer/change-history', label: 'Repricer Change History', ga: 'tool_menu_repricer_change_history', adminOnly: true },
  { path: '/tools/repricer/rule-behavior', label: 'Repricer Rule Behavior', ga: 'tool_menu_repricer_rule_behavior', adminOnly: true },
  { path: '/tools/repricer/checked-asins', label: 'Repricer Checked ASINs', ga: 'tool_menu_repricer_checked_asins', adminOnly: true },
  { path: '/tools/repricer/simulation', label: 'Repricer Simulation', ga: 'tool_menu_repricer_simulation', adminOnly: true },
  { path: '/tools/repricer/account-control', label: 'Repricer Account Control', ga: 'tool_menu_repricer_account_control', adminOnly: true },
  { path: '/tools/error-log', label: 'Repricer Error Log', ga: 'tool_menu_repricer_error_log', adminOnly: true },
  { path: '/tools/repricer/analytics', label: 'Repricer Analytics', ga: 'tool_menu_repricer_analytics', adminOnly: true },
  { path: '/tools/repricer/smart-engine', label: 'Repricer Smart Engine', ga: 'tool_menu_repricer_smart_engine', adminOnly: true },
