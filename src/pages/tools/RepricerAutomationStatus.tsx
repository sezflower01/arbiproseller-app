...
export default function RepricerAutomationStatus() {
  const { user } = useAuth();
        ...
        <main className="flex-1 container mx-auto px-4 py-8 pt-24 space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-foreground flex items-center gap-3">
              ...
              Repricer Automation Status
            </h1>
            <p className="text-muted-foreground mt-1">
              Live scheduler status, last run, and activity source breakdown for your account.
            </p>
          </div>
