...
SELECT cron.schedule(
  'validate-marketplace-sellability-30m',
  '*/30 * * * *',
  $$
  SELECT net.http_post(
    url := 'https://mstibdszibcheodvnprm.supabase.co/functions/v1/validate-marketplace-sellability',
    ...
    body := jsonb_build_object('mode', 'sweep', 'limit', 300),
