...
DO $$
BEGIN
  PERFORM cron.unschedule('smart-engine-outcome-snapshot-daily');
EXCEPTION WHEN OTHERS THEN
  NULL;
END $$;

SELECT cron.schedule(
  'smart-engine-outcome-snapshot-daily',
  '0 2 * * *',
  $$
  SELECT net.http_post(
    url := 'https://mstibdszibcheodvnprm.supabase.co/functions/v1/smart-engine-outcome-snapshot',
