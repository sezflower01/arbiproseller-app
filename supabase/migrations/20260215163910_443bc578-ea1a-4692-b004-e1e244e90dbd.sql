...
SELECT cron.unschedule('repricer-priority-cron');

-- Re-create with hardcoded URL/key matching other working cron jobs
SELECT cron.schedule(
  'repricer-priority-cron',
  '* * * * *',
  $$
  SELECT net.http_post(
    url := 'https://mstibdszibcheodvnprm.supabase.co/functions/v1/repricer-priority-cron',
